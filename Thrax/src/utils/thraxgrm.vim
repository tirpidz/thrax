...
syn keyword thraxBuiltinFunctions ArcSort CDRewrite Closure Compose Concat Connect Determinize Difference Expand Invert LoadFst LoadFstFromFar Minimize Optimize Project Reverse Rewrite RmEpsilon StringFile StringFst SymbolTable Union
